            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: dotColor.withOpacity((0.3 * glowVal).clamp(0.0, 1.0)),
                      blurRadius: 30,
                      spreadRadius: 8,
                    ),
                  ],
        ...
        return AnimatedBuilder(
          ...
          builder: (context, child) {
            return AnimatedOpacity(
              opacity: ((_controller.value * 3) % 3).floor() == index ? 1.0 : 0.3,
...
class GreenDotsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    int dotCount = state == VoiceSessionState.listening || 
    ...
    for (int i = 0; i < dotCount; i++) {
      ...
      if (state == VoiceSessionState.listening || state == VoiceSessionState.speaking) {
