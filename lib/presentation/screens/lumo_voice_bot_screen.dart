        ...
        return SizedBox(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Center Lumo logo with enhanced styling
              Container(
                width: 180,
                height: 180,
                decoration: BoxDecoration(
                ...
                child: ClipOval(
                  child: Image.asset(
                    KLumoIcon, // Use the proper Lumo mascot image
                    fit: BoxFit.cover,
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Transform.scale(
                      scale: 1.0 + (sin(_controller.value * 4 * pi) * 0.05),
                      child: Container(
                        width: 200,
                        height: 200,
                        decoration: BoxDecoration(
