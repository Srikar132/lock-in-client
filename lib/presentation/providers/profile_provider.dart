...
final profileStatsProvider = StreamProvider.family<ProfileStatsModel, String>((ref, userId) {
  return ref.watch(profileRepositoryProvider).streamProfileStats(userId);
});

// Achievements Stream Provider
final achievementsProvider = StreamProvider.family<List<AchievementModel>, String>((ref, userId) {
