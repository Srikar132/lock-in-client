    ...
    try {
      ...
      _channel!.sink.add(jsonEncode({
        ...
        'session': {
          ...
          'instructions': 'You are Lumo, a helpful AI voice assistant integrated into a focus and study app called LOCK-IN. Be concise, encouraging, and supportive. Help users with their study goals and productivity. Keep responses brief and clear.',
