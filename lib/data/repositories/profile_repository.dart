...
class ProfileRepository {
  ...
  Stream<List<AchievementModel>> streamAchievements(String userId) {
    return _firestore
      ...
      if (!snapshot.exists) {
        ...
        final defaultAchievements = AchievementModel.getDefaultAchievements();
      ...
      return achievementsMap.values
          .map((achievementData) =>
              AchievementModel.fromFirestore(achievementData as Map<String, dynamic>))
          .toList();
    });
  }

  // Update profile stats
  Future<void> updateProfileStats(String userId, ProfileStatsModel stats) async {
    await _firestore
        .collection('users')
        .doc(userId)
        .collection('profile')
  ...
  Future<void> updateAchievement(String userId, AchievementModel achievement) async {
    await _firestore
        .collection('users')
        .doc(userId)
        .collection('profile')
  ...
  Future<void> checkAndUnlockAchievements(String userId, ProfileStatsModel stats) async {
